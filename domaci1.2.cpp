/*
Написати програм за рад са бинарним стаблом претраживања (BST) које садржи
целобројне кључеве. BST се креира на основу уређеног низа кључева К дужине k из
задатка 1. Сматрати да у оквиру чвора стабла постоји показивач лево и десно подстабло,
као и показивач на оца. Уређеност кључева у стаблу може се модификовати тако да буде
у складу са уређеношћу низа К.
Потребно је подржати следеће операције за рад са стаблом бинарног претраживања:
1. [10 поена] Формирања стабла на основу уређеног низа кључева К
2. [10 поена] Уметање новог кључа у стабло
3. [5 поена] Претрагу стабла на задати кључ
4. [5 поена] Форматиран испис садржаја стабла
5. [5 поена] Евалуацију перформанси претраживања у BST над низом кључева
генерисањем секвенце кључева у задатом опсегу и одређивањем просечног броја
корака потребног за претраживање.
6. [5 поена] Брисање стабла из меморије

У зависности од редног броја ј проблема који се решава, уметање поновљених кључева
реализовати на следећи начин:
1. Чувањем листе свих кључева у оквиру једног чвора стабла
...
Напомена: Код исписа стабла, испис неке комбинације обилазака стабла се не прихвата
као адекватно решење, већ стабло треба адекватно форматирати.
*/
#include <algorithm>
#include <iostream>
#include <queue>
